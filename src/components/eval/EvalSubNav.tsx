...
const ITEMS = [
  { to: '/evaluations',              label: 'Cockpit',         icon: LayoutDashboard, end: true  },
  { to: '/evaluations/cycles',       label: 'Cycles',          icon: CalendarRange,   end: false },
  { to: '/evaluations/campagnes',    label: 'Campagnes',       icon: Megaphone,       end: false },
  { to: '/evaluations/liste',        label: 'Évaluations',     icon: ClipboardList,   end: false },
  { to: '/evaluations/360',          label: 'Feedback 360°',   icon: Eye,             end: false },
  { to: '/evaluations/calibration',  label: 'Calibration',     icon: Scale,           end: false },
