...
import { Briefcase, Users, UserCheck, LogOut, Plus, ArrowRight, Zap } from 'lucide-react';
...
export function TeamRecruitmentDashboardPage() {
  ...
  return (
    <div className="animate-fade-up space-y-5">
      ...
      <Card>
        <CardHeader title={`Mes candidats — ${pipe.position}`} action={<Users size={16} className="text-ink-400" />} />
