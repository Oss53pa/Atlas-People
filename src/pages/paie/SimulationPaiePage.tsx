...
import { FlaskConical, RotateCcw, UserSearch, AlertTriangle, ShieldCheck, ArrowRight, Cpu } from 'lucide-react';
...
export function SimulationPaiePage() {
  ...
  const bulletin = useMemo(() => buildBulletin(sim), [sim]);
